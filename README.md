...
- **商店 logo**：圖釘用品牌 logo（ 每家的  =  下的檔名，160px 內的 PNG）；預定地的 logo 自動變灰、外框虛線。logo 只用來辨識店家位置，商標屬各品牌所有。來源：
...
- **現場照片**：商店加 （ 下的檔名，jpg）與 ，彈窗會顯示照片、點照片可放大，圖釘右下角有 📷 角標。目前 星巴克／大埔／錢都／京懋接待會館共用一張蔡莎拉 2026-09 在鶯歌路拍的街景（1600px、約 200KB）；要換照片就換檔案，或再放一張並改檔名
